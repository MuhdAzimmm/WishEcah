...
introText.innerHTML = `Hi Ecah! Pull the cord.`;
...
function openCard() {
  ...
  // Show birthday text and buttons
  gsap.to(".birthday-text, .buttons", {
    display: "block",
    opacity: 1,
    duration: 0.5,
    delay: 0.5
